 ...
 */
package com.mind_era.knime.roles.nodes.internal;
 ...
 * @author Gabor Bakos
 */
public class RolesNodePlugin extends Plugin {
	// The shared instance.
	private static RolesNodePlugin plugin;

	/**
	 * The constructor.
	 */
	public RolesNodePlugin() {
		super();
		plugin = this;
	}
	...
	public void start(final BundleContext context) throws Exception {
		super.start(context);
		System.out.println(new RoleRegistry().roles());
	}
	 ...
	 */
	public static RolesNodePlugin getDefault() {
		return plugin;
	}
