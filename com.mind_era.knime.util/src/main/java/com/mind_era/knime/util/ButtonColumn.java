 ...
 * 
 * <br/>
 * From: http://tips4java.wordpress.com/2009/07/12/table-button-column/
 */
public class ButtonColumn extends AbstractCellEditor implements
	...
	private AbstractButton renderButton;
	 ...
	 */
	public ButtonColumn(final JTable table, final Action action,
			final int column) {
		this.table = table;
		this.action = action;
	...
	/**
	 * @return The mnemonic code for the action.
	 */
	...
	public void actionPerformed(final ActionEvent e) {
		...
		final ActionEvent event = new ActionEvent(table,
