 ...
 * @author Gabor Bakos
 */
//public final class IdRole implements Role {
//
//	/* (non-Javadoc)
...
//		return "A column with unique values identifying the rows/examples.";
//	}
//
//	/* (non-Javadoc)
...
//		return Arrays.asList(defaultName(), "rowKey", "rowId");
//	}
//
//	/* (non-Javadoc)
